...
class ControllerBase extends Controller
{
    ...
    /**
     * Generated Time datetime based on a timezone
     */
    ...
    /**
     * Fetch Lat & Lng Using Google map api
     * @param String
     * @return Array
     */
    public function getLatLngApi(string $string)
    {
        ...
        //Generate Custom data as key not present for google geocode api
        //TO-DO add key &key=238047890234j23h4jl2h34j2h34jkuh
        $latlngArray = [
            'latitude'  => 28.451687,   //$json_a['results'][0]['geometry']['location']['lat']; // get lat for json
            'longitude' => 77.072657    //$json_a['results'][0]['geometry']['location']['lng']; // get ing for json
        ];
     ...
     * Find element by ID from an specified model
     */
    public function findElementByPostId($model, $id)
    { 
